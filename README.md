...
Plan A was to give [OpenAPI Generator](https://openapi-generator.tech) a try, e.g.
...
Plan B is to modify the [basic asset transfer REST sample](https://github.com/hyperledger/fabric-samples/tree/main/asset-transfer-basic/rest-api-typescript).
