...
export const JOB_QUEUE_NAME = 'fabq';
 ...
 *
 */
export const peerAddressOrg1 = env
  .get('HLF_PEER_ADDRESS_ORG1')
  .required()
  .example('localhost:7051')
  .asString();

/**
 *
 */
export const peerAliasOrg1 = env
  .get('HLF_PEER_ALIAS_ORG1')
  .example('peer0.org1.example.com')
  .asString();

/**
 * Root certificate for the Org1 TLS Certificate Authority
 */
export const tlsRootCertificateOrg1 = env
  .get('HLF_TLS_ROOT_CERTIFICATE_ORG1')
  .required()
 ...
 *
 */
export const peerAddressOrg2 = env
  .get('HLF_PEER_ADDRESS_ORG2')
  .required()
  .example('localhost:9051')
  .asString();

/**
 *
 */
export const peerAliasOrg2 = env
  .get('HLF_PEER_ALIAS_ORG2')
  .example('peer0.org2.example.com')
  .asString();

/**
 * Root certificate for the Org2 TLS Certificate Authority
 */
export const tlsRootCertificateOrg2 = env
  .get('HLF_TLS_ROOT_CERTIFICATE_ORG2')
  .required()
  .example('"-----BEGIN CERTIFICATE-----\\n...\\n-----END CERTIFICATE-----\\n"')
  .asString();
